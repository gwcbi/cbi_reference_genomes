...
tar --use-compress-program=pigz -xf ../Archive/Homo_sapiens_UCSC_hg38.tar.gz
...
umask 0002
cd /groups/cbi/shared/References/cbi_reference_genomes.git/References
cd Homo_sapiens/UCSC/hg38/Annotation
...
cd /groups/cbi/shared/References/cbi_reference_genomes.git/References/Homo_sapiens/UCSC/hg38
